    ...
    demo_orders = [
        {
            ...
            "company_name": "",
            "customer_email": "blau01@benchflow.invalid",
        ...
        },
        {
            ...
            "customer_name": "Demo Kunde Echo",
            "company_name": "Keyboard Labor Demo",
            "customer_email": "echo02@benchflow.invalid",
        ...
        },
        {
            ...
            "customer_name": "Demo Kundin Pixel",
            "company_name": "",
            "customer_email": "pixel03@benchflow.invalid",
...
def build_generated_demo_orders():
    ...
    sample_orders = [
        {
            ...
            "customer_name": "Demo Crew Nord",
            "company_name": "Signalwerk Demo",
            "customer_email": "crew.nord04@benchflow.invalid",
            "customer_phone": "+49 151 20000004",
            "street": "Servicepark 19",
            "postal_code": "41040",
            "city": "Nordwerk",
            "preferred_contact": "email",
        ...
        },
        {
            ...
            "customer_name": "Demo Kunde Fokus",
            "company_name": "",
            "customer_email": "fokus05@benchflow.invalid",
        ...
        },
        {
            ...
            "customer_name": "Demo Studio Raster",
            "company_name": "Session Raster Demo",
            "customer_email": "raster06@benchflow.invalid",
    ...
    technicians = ["Bank 1", "Bank 2", "Bank 3"]
    statuses = [
        "Angenommen",
        "Diagnose",
        "Wartet auf Freigabe",
        ...
        generated.append(
            {
                ...
                "company_name": "Demo Stage Service" if index % 4 == 0 else "",
                "customer_email": f"demo{index:02d}@benchflow.invalid",
